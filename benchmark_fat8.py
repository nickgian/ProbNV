...
def start_benchmark(folder, filename):
    ...
    for ro in reordering_options:
        for so in simulator_options:
            ...
            try:
                wait_timeout(benchProcess, 2850) # do not set timeout to a too low value, it takes a few seconds to compile and install
...
start_benchmark("benchmarks/fat8/AllNodeFaults/","fat8_70_0_20_0_24_bfs_nodeFaults")
start_benchmark("benchmarks/fat8/AllNodeFaults/","fat8_70_0_20_0_24_default_nodeFaults")
start_benchmark("benchmarks/fat8/AllNodeFaults/","fat8_70_0_20_0_24_fat_nodeFaults")